...
@register_model
def HAT_Net_tiny(pretrained=False, **kwargs):
    model = HAT_Net(dims=[48, 96, 240, 384], head_dim=48, expansions=[8, 8, 4, 4],
        grid_sizes=[8, 7, 7, 1], ds_ratios=[8, 4, 2, 1], depths=[2, 2, 6, 3], **kwargs)
    model.default_cfg = _cfg()
    return model


@register_model
def HAT_Net_small(pretrained=False, **kwargs):
    model = HAT_Net(dims=[64, 128, 320, 512], head_dim=64, expansions=[8, 8, 4, 4],
        grid_sizes=[8, 7, 7, 1], ds_ratios=[8, 4, 2, 1], depths=[2, 3, 8, 3], **kwargs)
    model.default_cfg = _cfg()
    return model
...
def HAT_Net_medium(pretrained=False, **kwargs):
    model = HAT_Net(dims=[64, 128, 320, 512], head_dim=64, expansions=[8, 8, 4, 4],
        grid_sizes=[8, 7, 7, 1], ds_ratios=[8, 4, 2, 1], depths=[3, 6, 18, 3], kernel_sizes=[5, 3, 5, 3], **kwargs)
    model.default_cfg = _cfg()
    return model


@register_model
def HAT_Net_large(pretrained=False, **kwargs):
    model = HAT_Net(dims=[64, 128, 320, 640], head_dim=64, expansions=[8, 8, 4, 4],
        grid_sizes=[8, 7, 7, 1], ds_ratios=[8, 4, 2, 1], depths=[3, 8, 27, 3], kernel_sizes=[3, 3, 3, 3], **kwargs)
    model.default_cfg = _cfg()
    return model
